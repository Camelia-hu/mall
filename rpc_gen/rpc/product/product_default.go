...
func CreateProduct(ctx context.Context, req *product.CreateReq, callOptions ...callopt.Option) (resp *product.CreateResp, err error) {
...
func DeleteProduct(ctx context.Context, req *product.DeleteReq, callOptions ...callopt.Option) (resp *product.DeleteResp, err error) {
