...
import (
	...
	"github.com/Camelia-hu/mall/rpc_gen/kitex_gen/product/productcatalogservice"
...
func (c *clientImpl) CreateProduct(ctx context.Context, Req *product.CreateReq, callOptions ...callopt.Option) (r *product.CreateResp, err error) {
	return c.kitexClient.CreateProduct(ctx, Req, callOptions...)
}

func (c *clientImpl) DeleteProduct(ctx context.Context, Req *product.DeleteReq, callOptions ...callopt.Option) (r *product.DeleteResp, err error) {
