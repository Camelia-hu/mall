...
import (
	...
	"github.com/Camelia-hu/mall/rpc_gen/kitex_gen/auth/authservice"
...
func (c *clientImpl) ReFreshTokenByRPC(ctx context.Context, Req *auth.RefreshReq, callOptions ...callopt.Option) (r *auth.RefreshResp, err error) {
