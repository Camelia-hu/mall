...
import (
	...
	"github.com/Camelia-hu/mall/rpc_gen/kitex_gen/payment/paymentservice"
...
func (c *clientImpl) CreateCredit(ctx context.Context, Req *payment.CreateCreditReq, callOptions ...callopt.Option) (r *payment.CreateCreditResp, err error) {
	return c.kitexClient.CreateCredit(ctx, Req, callOptions...)
}
