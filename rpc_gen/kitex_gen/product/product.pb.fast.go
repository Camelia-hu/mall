...
func (x *CreateReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.Description, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *CreateReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	x.Picture, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *CreateReq) fastReadField5(buf []byte, _type int8) (offset int, err error) {
	x.Price, offset, err = fastpb.ReadFloat(buf, _type)
	return offset, err
}

func (x *CreateReq) fastReadField6(buf []byte, _type int8) (offset int, err error) {
	var v string
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_CreateResp[number], err)
}

func (x *CreateResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *CreateReq) fastWriteField3(buf []byte) (offset int) {
	if x.Description == "" {
		return offset
	}
...
func (x *CreateReq) fastWriteField4(buf []byte) (offset int) {
	if x.Picture == "" {
		return offset
	}
...
func (x *CreateReq) fastWriteField5(buf []byte) (offset int) {
	if x.Price == 0 {
		return offset
	}
...
func (x *CreateReq) fastWriteField6(buf []byte) (offset int) {
...
func (x *CreateResp) fastWriteField1(buf []byte) (offset int) {
	if x.Id == 0 {
		return offset
	}
...
func (x *CreateReq) sizeField3() (n int) {
	if x.Description == "" {
		return n
	}
...
func (x *CreateReq) sizeField4() (n int) {
	if x.Picture == "" {
		return n
	}
...
func (x *CreateReq) sizeField5() (n int) {
	if x.Price == 0 {
		return n
	}
...
func (x *CreateReq) sizeField6() (n int) {
	if len(x.Categories) == 0 {
		return n
	}
	for i := range x.GetCategories() {
...
func (x *CreateResp) sizeField1() (n int) {
	if x.Id == 0 {
		return n
	}
